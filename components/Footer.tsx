...
import { FaHome, FaRobot, FaBook, FaInfoCircle, FaGithub, FaLinkedin, FaEnvelope, FaArrowRight, FaHeart } from 'react-icons/fa';
...
export default function Footer() {
  ...
  const footerLinks = [
    ...
    { href: '/tutoriels', label: 'Tutoriels', icon: FaBook },
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-text-gray text-sm leading-relaxed mb-4">
              Blog passionné sur la domotique Home Assistant.
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-text-gray text-sm">
              © {currentYear} Alexandre Lebegue. Tous droits réservés.
            </p>
