...
import { FaHome, FaRobot, FaBook, FaInfoCircle } from 'react-icons/fa';
                  ...
                  return (
                    ...
                    >
                      <Link
                        ...
                        className={`flex items-center gap-3 font-medium transition-colors no-underline p-2 rounded-lg ${
                          active
                            ? 'text-accent bg-accent/10'
                            : 'text-text-dark hover:text-accent hover:bg-light-gray'
                        }`}
                      >
