...
export default function ChatbotPage() {
  ...
  const suggestions = [
    { text: "Comment installer Home Assistant ?", icon: "🏠" },
    { text: "Comment configurer Zigbee ?", icon: "📡" },
    { text: "Qu'est-ce que Nabu Casa ?", icon: "☁️" },
    { text: "Comment créer une automation ?", icon: "⚡" }
  ];
  ...
  return (
    <div className="min-h-screen bg-light-gray py-8">
      <div className="container max-w-4xl">
        {/* Header */}
        <motion.div 
          className="bg-gradient-to-br from-accent to-blue-600 rounded-lg shadow-lg p-8 mb-6 text-white relative overflow-hidden"
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              ...
              Posez vos questions sur Home Assistant et obtenez des recommandations personnalisées
            </motion.p>
          </div>
        </motion.div>
                ...
                >
                  <div className={`max-w-[80%] min-w-0 flex-shrink ${message.role === 'user' ? 'order-2' : 'order-1'}`}>
                    ...
                    <div className="flex items-start gap-3 w-full">
                      ...
                      <div className="flex-1 min-w-0">
                        <motion.div
                          className={`rounded-lg overflow-hidden w-full ${
                            message.role === 'user'
                              ? 'bg-gradient-to-br from-accent to-blue-600 text-white p-4'
                      ...
                      {message.role === 'user' && (
                        <motion.div 
                          className="w-10 h-10 bg-gradient-to-br from-accent to-blue-600 rounded-full flex items-center justify-center text-white flex-shrink-0"
                          whileHover={{ scale: 1.1, rotate: -5 }}
                        >
