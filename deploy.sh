...
# ====================================
# This script helps deploy the Blog Domotique application to Google Cloud Run
...
SERVICE_NAME="${SERVICE_NAME:-blog-domotique}"
REPO_NAME="${REPO_NAME:-blog-domotique-repo}"
...
show_usage() {
    cat << EOF
Blog Domotique - Cloud Run Deployment Script
